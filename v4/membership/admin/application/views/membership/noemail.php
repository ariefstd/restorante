...
<div class="content">
   ...
   <div class="header">
       <h2>No email Members</h2>
       <p style="padding-top:5px;">
       <a href="<?php echo base_url("index.php/membership/add"); ?>" class="buttonstyle1">Add New Member</a>
       <a href="<?php echo base_url("index.php/membership/export_excel/noemail"); ?>" class="buttonstyle1">Export to Excel</a>
	   <a href="<?php echo base_url("index.php/membership/email_reminder"); ?>" class="buttonstyle1">Send Bulk Message</a>
	   <a id="printpost" href="<?php echo base_url("index.php/membership/popprint_post/noemail"); ?>" class="buttonstyle1">Print Post</a>
       </p>
   </div>
