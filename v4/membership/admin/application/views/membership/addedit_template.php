...
<script>
	$(document).ready(function (){
		$("#btnDelete").click(function(){
			...
			if (answer){
				$.get('<?php echo base_url("index.php/membership/delete_template/".$id); ?>',function(data){
		...
		$("#btnSave").click(function(){
			$.post('<?php echo base_url("index.php/membership/saveupdate_template"); ?>',$("#sms").serialize(),function(data){
				parent.jQuery.fancybox.close();					
			});
			return false;
		});	
   	...
   	<form id="sms" method="post" action="<?php echo base_url("index.php/membership/saveupdate_template"); ?>">
