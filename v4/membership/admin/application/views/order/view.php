        ...
        <table cellpadding="0" cellspacing="0" class="general_table" >
            ...
            foreach ($result as $resultdata)
            {
                ...
                <tr>
                    ...
                    <td width="150" class="center"><?php echo $resultdata['order_date'].' '.$resultdata['order_time']; ?></td>
                    <td width="150" class="center"><?php echo $resultdata['event_date'].' '.$resultdata['event_time']; ?></td>
