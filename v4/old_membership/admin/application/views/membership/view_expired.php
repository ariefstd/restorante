...
<div class="content">
   ...
   <div class="header">
       ...
       <a href="<?php echo base_url("index.php/membership/export_expired_excel"); ?>" class="buttonstyle1">Export to Excel</a>
       <a href="<?php echo base_url("index.php/membership/email_reminder/expired"); ?>" class="buttonstyle1">Send Email Reminder</a>
       <a href="<?php echo base_url("index.php/sms/send_sms/expired"); ?>" class="buttonstyle1">Send Bulk Message</a>
       </p>
   </div>
