...
<div class="content">
   ...
   <div class="header">
       ...
       <a href="<?php echo base_url("index.php/membership/export_excel/expiry"); ?>" class="buttonstyle1">Export to Excel</a>
       <a href="<?php echo base_url("index.php/membership/email_reminder/expiredsoon"); ?>" class="buttonstyle1">Send Email Reminder</a>
       <a href="<?php echo base_url("index.php/sms/send_sms/expiredsoon"); ?>" class="buttonstyle1">Send Bulk Message</a>
       </p>
   </div>
