                        ...
                        if($size_of_record > 0)
                        {
							...
							foreach ($result->result_array() as $resultdata)
							{
								...
								<tr>
									...
									<?php if($permission == 1) { ?>
                                    <td class="center">
                                        <a href="<?php echo base_url("index.php/membership/email_detail").'/'.$resultdata['id']; ?>">Detail</a>
                                        <a href="<?php echo base_url("index.php/membership/set_email_status").'/'.$resultdata['id']; ?>">On/Off Status</a>
                                    </td>
                                    <?php } ?>
								</tr>
