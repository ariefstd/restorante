...
<div class="content">
   ...
   <div class="header">
       ...
       <a href="<?php echo base_url("index.php/membership/export_excel/birthday"); ?>" class="buttonstyle1">Export to PDF</a>
       <a href="<?php echo base_url("index.php/membership/email_reminder/birthday"); ?>" class="buttonstyle1">Send Email Reminder</a>
       <a href="<?php echo base_url("index.php/sms/send_sms/birthday"); ?>" class="buttonstyle1">Send Bulk Message</a>
       <a id="printpost" href="<?php echo base_url("index.php/membership/popprint_post/birthday"); ?>" class="buttonstyle1">Print Post</a>
       </p>
   </div>
				...
				?>
                	...
                	<table cellpadding="0" cellspacing="0" class="general_table" >
                    	<tr>
                            ...
                            <th width="100" align="center">Birthday</th>
                        ...
                        if($size_of_record > 0)
                        {
							...
							foreach ($result->result_array() as $resultdata)
							{
								...
								<tr>
                                    ...
                                    <td width="100" class="center"><?php echo date("d/m/Y",strtotime($resultdata['dob'])); ?></td>
