...
<div class="content">
   ...
   <div class="header">
       <h2>No Username Members</h2>
       <p style="padding-top:5px;">
       <a href="<?php echo base_url("index.php/membership/add"); ?>" class="buttonstyle1">Add New Member</a>
       <a href="<?php echo base_url("index.php/membership/export_excel/usernamepass"); ?>" class="buttonstyle1">Export to Excel</a>
	   <a href="<?php echo base_url("index.php/sms/send_sms/usernamepass"); ?>" class="buttonstyle1">Send Bulk Message</a>
	   <a id="printpost" href="<?php echo base_url("index.php/membership/popprint_post/usernamepass"); ?>" class="buttonstyle1">Print Post</a>
       </p>
   </div>
                        ...
                        if($size_of_record > 0)
                        {
							...
							foreach ($result->result_array() as $resultdata)
							{
								...
								<tr>
									...
									<td width="80" class="center"><?php echo $resultdata['id']; ?></td>
...
<script>
	...
	$(document).ready(function (){
		...
		$("#printpost").fancybox({'type' : 'iframe'});
